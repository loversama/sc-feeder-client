...
(function(module, exports) {
  ...
  var __importStar = commonjsGlobal && commonjsGlobal.__importStar || function(mod) {
    ...
    var result = {};
    if (mod != null) {
      for (var k in mod) if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) _get__("__createBinding")(result, mod, k);
    }
...
(function(module, exports) {
  ...
  function applyFill(element, svgColor, fgColor, color2 = true) {
    ...
    if (element && element !== null) {
      if (color2) element.style.color = fillColor;
...
function requireSubmenu() {
  if (hasRequiredSubmenu) return submenu.exports;
...
function requireMenu() {
  if (hasRequiredMenu) return menu.exports;
  hasRequiredMenu = 1;
  (function(module, exports) {
    Object.defineProperty(exports, "__esModule", {
      value: true
  ...
  class CustomTitlebar extends _get__("themebar_1").ThemeBar {
    ...
    setupBackgroundColor() {
      ...
      if (!color2) {
        ...
        if (!color2) color2 = _get__("color_1").Color.WHITE;
    ...
    onMenuBarFocusChanged(focused) {
      if (_get__("platform_1").isWindows || _get__("platform_1").isLinux || _get__("platform_1").isFreeBSD) {
        if (focused) (0, _get__("dom_1").hide)(this.dragRegion);
        else (0, _get__("dom_1").show)(this.dragRegion);
      }
    }
    onDidChangeMaximized(isMaximized) {
      ...
      if (this.resizer) {
        if (isMaximized) (0, _get__("dom_1").hide)(this.resizer.top, this.resizer.left);
        else (0, _get__("dom_1").show)(this.resizer.top, this.resizer.left);
      }
    }
    updateMenu(menu2) {
      if (_get__("platform_1").isMacintosh || !menu2) return;
...
window.addEventListener("DOMContentLoaded", () => {
  new customElectronTitlebarExports.Titlebar({
    ...
    overflow: "auto",
    enableMnemonics: true,
    backgroundColor: customElectronTitlebarExports.TitlebarColor.fromHex("#121212"),
